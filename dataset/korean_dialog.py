...
class KDDCIDSFPOSDataset(Dataset):
    split2file = {
    ...
    def __init__(self, split, data_dir = 'data/kg'):
    ...
    def get_slot_intent_domain(self,dataset):
        ...
        return all_turns, slot_value_pairs, all_states, all_domains
    ...
    def init_data(self):
        ...
        turns, slot_value_pairs, states, domains = self.get_slot_intent_domain(raw_data)
        self.turns = turns
